...
public class AdapterCategoryBook1 extends RecyclerView.Adapter<ViewHoderBook> {
    DAO_Book dao_book;
    ArrayList<Book> listBook1;
    ArrayList<Category> listCategory;
    DAO_BookCategory dao_bookCategory;
    Context context;

    public AdapterCategoryBook1(DAO_Book dao_book, ArrayList<Book> listBook1, ArrayList<Category> listCategory, DAO_BookCategory dao_bookCategory) {
        this.dao_book = dao_book;
        this.listBook1 = listBook1;
    ...
    public int getItemCount() {
        return listBook1 == null ? 0 : listBook1.size();
    }
