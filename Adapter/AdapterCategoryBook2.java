...
public class AdapterCategoryBook2 extends RecyclerView.Adapter<ViewHoderBook> {
    DAO_Book dao_book;
    ArrayList<Book> listBook2;
    ArrayList<Category> listCategory;
    DAO_BookCategory dao_bookCategory;
    Context context;

    public AdapterCategoryBook2(DAO_Book dao_book, ArrayList<Book> listBook2, ArrayList<Category> listCategory, DAO_BookCategory dao_bookCategory) {
    ...
    public int getItemCount() {
        return listBook2 == null ? 0 : listBook2.size();
    }
